(function() {
  var RootTask, TaskFactory, crc32, fileRegexp, path, plugin;
  ...
  require("colorcode").code(/^(==> )/, "$1".cyan).code(/( -> )/, "$1".cyan).code(/( \+ )/, "$1".cyan).code(fileRegexp, function(value) {
    value.match(fileRegexp).forEach(function(file) {
