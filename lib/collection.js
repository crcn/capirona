(function() {
  var TaskDirector, TaskMessenger, Tasks, beanpoll, dolce, outcome, structr, _,
  ...
  TaskMessenger = (function(_super) {
    ...
    */
    ...
    TaskMessenger.prototype._next = function(middleware) {
      var _this = this;
      structr.copy(middleware.params, this.request.query);
  ...
  module.exports = Tasks = (function() {
    ...
    */
    ...
    Tasks.prototype._extendRoute = function(target, parents) {
      var parent, parentCopy, thru, _i, _len, _ref;
    ...
    */
    ...
    Tasks.prototype.run = function(path, target, next) {
      _.defaults(target, this.makeConfig.config);
