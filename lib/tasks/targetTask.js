  ...
  module.exports = TargetTask = (function(_super) {
    ...
    */
    ...
    TargetTask.prototype._run = function(target, next) {
      var obj, oldConfig, renderedConfig;
      obj = {};
      oldConfig = structr.copy(target);
      oldConfig = structr.copy(this.target, oldConfig);
      renderedConfig = tpl.render(this.target, oldConfig);
    ...
    */
    ...
    TargetTask.prototype._taskMessage = function(target) {
      if (target.currentPath) return "target " + target.currentPath;
    };
