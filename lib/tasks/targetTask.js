  ...
  module.exports = TargetTask = (function(_super) {
    ...
    */
    ...
    TargetTask.prototype.load = function(target) {
      this.target = target;
      this.task = this.tasks.factory.newTask(null, this.target.task);
      if (!this.tasks.targets) this.tasks.targets = [];
      return this.tasks.targets.push(this);
    };
    ...
    */
    ...
    TargetTask.prototype._taskMessage = function(target) {
      return "target " + (this.route ? this.route.path.value : target.name || "");
    };
