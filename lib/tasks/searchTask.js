(function() {
  var BaseTask, SearchTask, handlebars, outcome, parseTpl, structr, walkr,
  ...
  module.exports = SearchTask = (function(_super) {
    ...
    SearchTask.prototype.load = function(options) {
      ...
      for (search in options.find) {
        _results.push(tasks.push({
          ...
          task: this.tasks.factory.newTask(null, options.find[search])
        }));
      }
      return _results;
    };
    ...
    */
    ...
    SearchTask.prototype._run = function(target, nextTask) {
      var dir,
        _this = this;
      dir = parseTpl(this.options.directory, target);
